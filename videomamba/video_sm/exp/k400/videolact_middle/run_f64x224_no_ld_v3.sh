...
# V3 uses private projections initialized from attention Q/K/V/O and a
# zero-initialized memory-only channel gate.
RUN_NAME="video-lact-middle-k400-f64x224-no-ld-10ep-private-qkvo-gate-v3"
